...
means_list_22 <- replicate(n = 200, expr = mean(sample(df$Sepal.Length, size = 30, replace = TRUE)))
means_list_33 <- replicate(n = 1000, expr = mean(sample(df$Sepal.Length, size = 50, replace = TRUE)))
means_list_44 <- replicate(n = 3000, expr = mean(sample(df$Sepal.Length, size = 50, replace = TRUE)))
means_list_55 <- replicate(n = 10000, expr = mean(sample(df$Sepal.Length, size = 50, replace = TRUE)))
